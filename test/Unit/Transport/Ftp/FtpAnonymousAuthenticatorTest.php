...
use Gtlogistics\EdiClient\Transport\Ftp\FtpAnonymousAuthenticator;
...
#[CoversClass(FtpAnonymousAuthenticator::class)]
#[UsesClass(FtpConnection::class)]
#[UsesClass(FtpPasswordAuthenticator::class)]
class FtpAnonymousAuthenticatorTest extends TestCase
{
    public function testAuthenticate(): void
    {
        ...
        $mock->expects($this->once())
            ->method('login')
            ->with('anonymous', 'guest')
        ;

        $authenticator = new FtpAnonymousAuthenticator();
